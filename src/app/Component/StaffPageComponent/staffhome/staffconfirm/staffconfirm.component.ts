...
@Component({
  selector: 'app-staffconfirm',
  templateUrl: './staffconfirm.component.html',
  styleUrls: ['./staffconfirm.component.css']
})
export class StaffconfirmComponent implements OnInit {
